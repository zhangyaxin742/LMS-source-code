...
const Profile: React.FC = () => {
  ...
  // Only show the My Profile tab for students
  return (
    <div className="container mx-auto space-y-6 py-6">
      ...
      >
        <h1 className="text-3xl font-semibold tracking-tight mb-6">Profile Management</h1>
        ...
        {userRole === "student" ? (
          ...
          <Tabs defaultValue="my-profile" className="space-y-6">
            <TabsList className="mb-4">
              ...
              <TabsTrigger value="student-profiles" className="flex items-center gap-2">
